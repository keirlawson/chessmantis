...
public class Sifaka extends Capuchin implements Evaluator
{
	...
	private static final int PQEQ8 = PV; //Pawn Quantity EQuals 8
	private static final int PQEQ7 = PV / 2; // Pawn Quantity EQuals 7
	...
	private static final int CFCP = PV / 2; // Crowded Files Crippled Pawn
	private static final int IP = PV / 2; // Isolated Pawn
	private static final int PP = PV; // Passed Pawn
	private static final int PAS = PV; // Pawn Advance static
	private static final float PAM = 0.3f; // Pawn Advance Multiplier
	private static final float PPM = 0.5f; // Piece Pairs Multiplier
