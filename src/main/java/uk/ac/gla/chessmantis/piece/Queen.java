 ...
 * uk.ac.gla.chessmantis.piece.Queen: queen chess piece subclass
...
public class Queen extends GenericPiece 
{
	...
	/**
	 * Constructor
	 * initializes the basic fields of the new uk.ac.gla.chessmantis.piece.Queen
	 * and sets its colour
	 ...
	 * Constructor
	 * @author TT
	 * instantiates uk.ac.gla.chessmantis.piece.Queen, where colour is not available
	 */
	public Queen ()
	{
		this.value = 300;
