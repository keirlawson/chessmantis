...
public class Mantis extends BoardArray implements Evaluator
{
	 ...
	 * modifier
	 * @author TT
	 * @param degran sets the degree of randomness, 0 to deactivate
	 */
	...
	private static final int PQEQ8 = PV / 10; // uk.ac.gla.chessmantis.piece.Pawn Quantity EQuals 8
	private static final int PQEQ7 = PV / 20; // uk.ac.gla.chessmantis.piece.Pawn Quantity EQuals 7
	private static final int CFEQ2 = PV / 2; // Crowded Files EQuals 2
	private static final int CFGT2 = PV; // Crowded Files Greater Than 2
	private static final int CFCP = PV / 4; // Crowded Files Crippled uk.ac.gla.chessmantis.piece.Pawn
	private static final float PPM = 0.25f; // uk.ac.gla.chessmantis.piece.Piece Pairs Multiplier
	private static final int KAFA = PV / 50; // uk.ac.gla.chessmantis.piece.King Attack First Aura
	private static final int KASA = PV / 100; // uk.ac.gla.chessmantis.piece.King Attack Second Aura
	...
	private static final int KC = 50; // uk.ac.gla.chessmantis.piece.King Center.
	private static final int KP = 8; // uk.ac.gla.chessmantis.piece.King Pawns;
	private static final int IP = 8; // uk.ac.gla.chessmantis.piece.King Pawns;
	...
	Also calculates if the uk.ac.gla.chessmantis.piece.King is in the center of the board, which is bad at
	...
	Isolated Pawns = Calculates whether a pawn has any protection from neighbouring files. Should also satisfy uk.ac.gla.chessmantis.piece.Pawn Islands.
	uk.ac.gla.chessmantis.piece.King Pawns - Calculates whether the uk.ac.gla.chessmantis.piece.King has any pawns of its own colour protecting it.
	*/
