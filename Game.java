...
public class Game
{
	...
	private void ProcessEvent(MoveEvent me)
	{
		...
		if (b.makeMove(me.getMove()))
		{
			...
			{
				System.err.println("Game.java: Thinks stalemate has occured");
				// Create a status event - Draw
				g.x.write(new StatusEvent(Status.Draw));
			} */
			else
			{
				if (think)
